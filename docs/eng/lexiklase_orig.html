...
<ul>
	...
	<li><strong><a href="./inharelexi.html#falelexili_klase">falelexi</a></strong> <em>(f)</em> - verb <em>(v)</em>
		<ul>
			...
			<li><strong>ojetoli falelexi</strong> <em>(b.oj)</em> - transitive verb <em>(v.tr)</em>
				<ul>
					<li><strong>rusoti-ojetoli falelexi</strong> <em>(b.oj.ru)</em> - echo-object transitive verb
						<em>(v.tr.e)</em>
					</li>
				</ul>
			</li>
