...
<p><strong>Fe</strong> често се използва в начални фрази на изречения със съществителни.</p>
<ul>
...
<p>С глаголи:</p>
<ul>
	<li><strong>max... kom....</strong> или <strong>max kom...</strong> - повече от/отколкото</li>
</ul>
...
<ul>
	...
	<li><strong>velosi</strong> - бърз(о), бързо</li>
	<li><strong>multi</strong> - много</li>
</ul>
<p>Прилагателните/наречията предшестват съществителните/глаголите, които модифицират.</p>
<p><strong>Hinto sen <em>bon yam</em>.</strong><br /> Това е <em>добро ядене</em>.</p>
...
<h2>Общи афикси</h2>
<h3>Именна наставка -ya <span id="xafefikso_-ya"></span></h3>
...
<p>Естествено, тези фрази могат да бъдат изразени и като пълни подчинени изречения, вместо предложни фрази.</p>
