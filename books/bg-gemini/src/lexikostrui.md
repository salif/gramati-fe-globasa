...
<p>Представките не променят частта на речта на думата, към която са прикрепени. От друга страна, наставките го правят и
	се дефинират като прилагателни/наречия наставки или съществителни/глаголни наставки.</p>
...
<ul>
	<li><strong>aw-:</strong> отсъстващ, далеч <ul>
			<li><strong>awidi</strong> - напускам, отивам си (<em>idi</em> - <em>отивам</em>); <strong>awglu</strong> -
				изпивам (<em>glu</em> - <em>пия</em>); <strong>awpel</strong> - прогонвам (<em>pel</em> -
				<em>карам/бутам</em>)</li>
		</ul>
	</li>
	<li><strong>awto-:</strong> авто- (<em>автоматичен, сам по себе си</em>) [<strong>awtomati</strong> - автоматичен,
		<strong>awtonom</strong> - автономен] <ul>
			<li><strong>awtosahigi</strong> - автокорекция (<em>sahi - правилен; sahigi - коригирам</em>)</li>
		</ul>
	</li>
	<li><strong>dis-:</strong> разпръсквам, разсейвам <ul>
			<li><strong>disgibe</strong> - раздавам (<em>gibe</em> - <em>давам</em>)</li>
		</ul>
	</li>
	...
	<li><strong>fron-:</strong> напред [<strong>fronta</strong> - чело, предна част] <ul>
			<li><strong>fronkadam</strong> - напредвам, прогресирам (<em>kadam</em> - <em>стъпка</em>)</li>
		</ul>
	</li>
	<li><strong>ja-:</strong> непосредствено до [<strong>jara</strong> - съсед] <ul>
			<li><strong>jale</strong> - току-що (съм) (<em>le - частица за минало време на глагола</em>);
				<strong>jaxa</strong> - предстои да (<em>xa - частица за бъдеще време на глагола</em>);
	...
	<li><strong>nen-:</strong> не-, без- <ul>
			<li><strong>nenmuhim</strong> - маловажен (<em>muhim</em> - <em>важен</em>); <strong>nenkompleto</strong> -
				...
				<strong>imanunenible</strong> - невероятен (<em>imanu - вярвам</em>)</li>
		</ul>
	</li>
...
<h2>Наставки за съществителни имена</h2>
<ul>
	<li><strong>-gon:</strong> -ъгълник (<em>геометрична фигура</em>) [<strong>gona</strong> - ъгъл] <ul>
...
<h2>Функционални думи като квазипредставки в сложни думи</h2>
<ul>
...
<h2>Съществителни/глаголни думи като квазипредставки в сложни думи</h2>
<ul>
...
<h2>Прилагателни/наречия като квазипредставки в сложни думи</h2>
...
<h2>Числа като квазипредставки в сложни думи</h2>
...
<ul>
	...
	<li><strong>kal:</strong> празен; <em>в сложни думи:</em> -без <ul>
			<li><strong>legakal</strong> - нелегален, беззаконен (<em>lega</em> - <em>закон</em>);
	...
	<li><strong>kolordo (<em>kolor-do</em>):</strong> оттенък, оцветен (Вижте също <strong>-sim</strong>.) <ul>
	...
	<li><strong>laye:</strong> достоен <ul>
			<li><strong>xinloylaye</strong> - достоен за доверие (<em>xinloy</em> - <em>доверие</em>);
				...
				<strong>doxolaye</strong> - достоен за четене (<em>doxo</em> - <em>чета</em>)</li>
		</ul>
	</li>
	<li><strong>musi:</strong> трябва; <em>в сложни думи:</em> (активен залог) трябва; (страдателен залог) трябва да
		бъде, повелителен <ul>
			<li>активен: <strong>triunfamusi</strong> - който трябва да победи (<em>triunfa</em> - <em>побеждавам</em>)
			</li>
			<li>страдателен: <strong>beokomusi</strong> - задължителен за гледане (<em>oko - виждам; beoko - бивам
					видян</em>)</li>
		</ul>
	</li>
	<li><strong>peldo (<em>pel-do</em>):</strong> подтикван <ul>
			<li><strong>somnopeldo</strong> - сънлив (<em>somno</em> - <em>сън</em>); <strong>yampeldo</strong> - гладен
				(<em>yam</em> - <em>ям</em>)</li>
		</ul>
	</li>
	<li><strong>pul:</strong> пълен; <em>в сложни думи:</em> -ен (с изобилие от) <ul>
			<li><strong>kimapul</strong> - скъп, ценен (<em>kima</em> - <em>цена</em>); <strong>juipul</strong> -
				внимателен (<em>jui</em> - <em>внимание</em>); <strong>brilapul</strong> - лъскав (<em>brila</em> -
				<em>блясък</em>); <strong>pesapul</strong> - богат (<em>pesa</em> - <em>пари</em>);
				<strong>hataripul</strong> - опасен (<em>hatari</em> - <em>опасност</em>); <strong>legapul</strong> -
				легален, законен (<em>lega</em> - <em>закон</em>); <strong>bawlupul</strong> - насилствен
				(<em>bawlu</em> - <em>насилие</em>)</li>
		</ul>
	</li>
	<li><strong>sim:</strong> подобен; <em>в сложни думи:</em> -подобен, -оват, оттенък на цвят <ul>
...
<ul>
	...
	<li><strong>ente:</strong> нежив агент <ul>
			<li><strong>medisente</strong> - лекарство (<em>medis - лекарство</em>); <strong>antigutonente</strong> -
	...
	<li><strong>kaxa:</strong> контейнер <ul>
			<li><strong>anjenkaxa</strong> - сейф (<em>anjen</em> - <em>безопасен</em>); <strong>bezekaxa</strong> -
				пчелен кошер (<em>beze</em> - <em>пчела</em>)</li>
		</ul>
	</li>
	...
	<li><strong>lari:</strong> събирателна група <ul>
			<li><strong>insanlari</strong> - човечество (<em>insan</em> - <em>човешко същество</em>);
				...
				стадо добитък (<em>mumu</em> - <em>бик/крава, добитък</em>); <strong>lexilari</strong> - речник, лексика
				(<em>lexi</em> - <em>дума</em>); <strong>menalari</strong> - речник (с дефиниции) (<em>mena</em> -
				<em>значение</em>, <em>дефиниция</em>); <strong>navilari</strong> - флотилия (<em>navi</em> -
				<em>кораб</em>); <strong>yumawlari</strong> - оперение (<em>yumaw</em> - <em>перо</em>)</li>
		</ul>
	</li>
	...
	<li><strong>pel:</strong> (външно) подтиквам, тласкам; карам някого да иска (да) <ul>
			<li><strong>seksopel</strong> - сексапил, сексуално привличане (<em>sekso - секс</em>);
				<strong>jixipel</strong> - карам (някого) да се чуди</li>
		</ul>
	</li>
...
<p>Сложните съществителни имена, като горните, могат да се изразяват като прилагателни, като просто се добави наставката
	<strong>-li</strong>. </p>
