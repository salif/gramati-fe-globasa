...
<p>В речника глаголите се дефинират като <em>помощни</em>, <em>копулативни</em>, <em>преходни</em>, <em>непреходни</em>
	или <em>амбитранзитивни</em>. Наставките, използвани в този раздел (<strong>-cu</strong>, <strong>-gi</strong>,
	<strong>-ne</strong>, <strong>-do</strong>, <strong>-pul</strong>), са обяснени в раздела <a
		href="./inharelexi.html#pimpan_fikso"><em>Често срещани афикси</em></a> по-долу. Представката
	<strong>xor-</strong> е обяснена в раздела <a href="./lexikostrui.html#lefefikсо"><em>Словообразуване:
			Представки</em></a>.</p>
<h4>Помощни глаголи</h4>
<p><em>Помощните глаголи</em> са непосредствено последвани от друг глагол, който може да бъде пропуснат. В глобаса има
	само три <em>помощни глагола</em>: <strong>abil</strong> (мога, способен съм да), <strong>ingay</strong> (трябва
	да), <strong>musi</strong> (трябва, налага се да). </p>
...
<p><em>Копулативните глаголи</em> свързват подлога с неговото допълнение. В момента има 12 <em>копулативни глагола</em>:
	...
	<strong>orecu</strong> (звуча), <strong>nasacu</strong> (мириша), <strong>xetocu</strong> (имам вкус на),
	<strong>pifucu</strong> (чувствам се на допир), <strong>hisicu</strong> (чувствам се физически или емоционално),
...
<p><em>Непреходните глаголи</em> не приемат пряко допълнение: <strong>idi</strong> (отивам), <strong>konduta</strong>
	...
	употреба на <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong> при наличие на пряко допълнение. </p>
<ul>
	<li><strong>garaku</strong> - давя се, потъвам<br />
		<strong>garaku(gi)</strong> - (карам да се) дави, (карам да) потъва
	</li>
</ul>
...
<p><strong>garakugine navikef</strong>- капитанът, който потапя (кораба)</p>
...
<p><a href="https://en.wikipedia.org/wiki/Ambitransitive_verb#Patientive"><em>Амбитранзитивните глаголи</em></a> в
	глобаса са глаголи, при които както подлогът при непреходното значение, така и прякото допълнение при преходното
	значение изпитват едно и също действие/състояние на глагола. Непреходното значение на тези глаголи може
	незадължително да прилага <strong><a href="./inharelexi.html#xafefikso_-cu">-cu</a></strong>, а преходното значение
	може незадължително да прилага <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong>.</p>
<p>Има четири подкатегории <em>амбитранзитивни глаголи</em>: <em>глаголи за чувство</em>, <em>глаголи за състояние</em>,
	<em>безлични глаголи</em> и <em>глаголи за позиция/местоположение или движение</em>. </p>
<p><em>Глаголи за чувство</em></p>
<p><em>Амбитранзитивните глаголи</em>, обозначаващи чувство, означават <em>чувствам [коренно съществително] или карам да
		се чувства [коренно съществително]</em>. Обърнете внимание, че непреходното значение може да бъде изразено и
	като фраза с копулативен глагол и прилагателно: <strong>sen</strong> <em>[коренно съществително]</em><strong><a
			href="./inharelexi.html#xafefikso_-do">-do</a></strong>.</p>
<ul>
	<li><strong>interes(cu)</strong> - интересувам се/чувствам интерес (<em>чувствам интерес</em>)<br />
		<strong>interes(gi)</strong> - интересувам (<em>карам да се чувства интерес</em>)
	</li>
</ul>
<p><strong>Mi interes(cu) tem basalogi.</strong> = <strong>Mi sen interesdo tem basalogi.</strong><br /> Интересувам се
	от лингвистика.</p>
...
<ul>
	<li><strong>pilo(cu)</strong> - уморен съм/чувствам се уморен (<em>чувствам умора</em>)<br />
		<strong>pilo(gi)</strong> - изморявам (<em>карам да се чувства умора</em>)
	</li>
</ul>
<p><strong>Te pilo(cu).</strong> = <strong>Te sen pilodo.</strong><br /> Тя е уморена/чувства се уморена.</p>
<p><strong>Tesu ergo pilo(gi) te.</strong><br /> Нейната работа я изморява.</p>
<p>Представката <strong>xor-</strong> може да се използва с <em>глаголи за чувство</em>, за да се изрази следната
	разлика:</p>
...
<p>срещу:</p>
<p><strong>Mi le xorinteres tem basalogi lefe multi nyan.</strong><br /> Започнах да се интересувам от лингвистика преди
	много години.</p>
...
<p><em>Амбитранзитивните глаголи за състояние</em> са подобни на <em>глаголите за чувство</em>. Те са <em>съществителни
		за състояние</em>, които могат да се използват като <em>амбитранзитивни глаголи</em> със значение <em>имам
		[коренно съществително] или карам да има [коренно съществително]</em>. Обърнете внимание, че непреходното
	значение може да бъде изразено и като фраза с копулативен глагол и прилагателно: <strong>sen</strong> <em>[коренно
		съществително]</em><strong><a href="./inharelexi.html#xafefikso_-pul">-pul</a></strong>. </p>
<ul>
	<li><strong>termo(cu)</strong> - топъл съм/горещ съм (<em>имам топлина</em>)<br />
		<strong>termo(gi)</strong> - затоплям (<em>карам да има топлина</em>)
	</li>
</ul>
...
<p>Представката <strong>xor-</strong> може да се използва с <em>глаголи за състояние</em>, за да се изрази следната
	разлика:</p>
...
<p><strong>To le xortermo fe midinuru.</strong> = <strong>To le xorsen/sencu termopul fe midinuru.</strong><br /> Стана
	топло по обяд. </p>
<p><em>Безлични глаголи</em></p>
<p>При непреходното значение на <em>безличните амбитранзитивни глаголи</em> действието е нещо, което се случва на
	подлога, а не нещо, което подлогът извършва. </p>
<ul>
	<li><strong>kasiru(cu)</strong> - чупя се (<em>ставам счупен</em>)<br />
...
<ul>
	<li><strong>boyle(cu)</strong> - варя се (<em>ставам сварен</em>)<br />
		<strong>boyle(gi)</strong> - варя (<em>карам да се свари</em>)
	</li>
</ul>
<p><strong>Sui le boyle(cu).</strong><br /> Водата завря.</p>
<p><strong>Te le boyle(gi) sui.</strong><br /> Тя свари водата.</p>
<ul>
	<li><strong>fini(cu)</strong> - свършвам (<em>стигам до край</em>)<br />
		<strong>fini(gi)</strong> - завършвам, приключвам (<em>карам да стигне до край</em>)
	</li>
</ul>
<p><strong>Jange le fini(cu).</strong><br /> Войната свърши.</p>
<p><strong>Ete le fini(gi) jange.</strong><br /> Те приключиха войната.</p>
<p><em>Глаголи за позиция/местоположение или движение</em></p>
<p>При непреходното значение на <em>амбитранзитивните глаголи за позиция/местоположение или движение</em> подлогът е
	едновременно деятел и потърпевш. </p>
<ul>
	<li><strong>esto(cu)</strong> - спирам (<em>стигам до спиране</em>)<br />
...
<ul>
	<li><strong>harka(cu)</strong> - движа се (<em>извършвам движение</em>)<br />
		<strong>harka(gi)</strong> - движа (<em>карам да се движи</em>)
	</li>
</ul>
<p><strong>Am no harka(cu)!</strong><br /> Не мърдай!</p>
<p><strong>Mi le harka(gi) yusu kursi.</strong><br /> Преместих твоя стол. </p>
<ul>
...
<p>При словообразуването <em>амбитранзитивните глаголи</em> функционират като <em>преходни глаголи</em> без нужда от
	<strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong>. Когато обаче е необходимо <em>непреходното</em>
	значение на глагола при словообразуването, трябва да се приложи <strong><a
			href="./inharelexi.html#xafefikso_-cu">-cu</a></strong>. Сравнете следните прилагателни, образувани с
	<strong>buka</strong> и наставката <strong><a href="./inharelexi.html#xafefikso_-ne">-ne</a></strong>:</p>
<p><strong>bukane merasem</strong> - церемонията по откриването</p>
