<h1>Palavras de função: Conjunções, preposições e advérbios de função</h1>
<p>
</p>
<p>Clique <a href="./pornamelexi.html">aqui</a> para ver Pronomes. Clique <a href="./tabellexi.html">aqui</a> para ver
	Correlativos. Clique <a href="./numer-ji-mesi.html">aqui</a> para ver Números.</p>
<h2>Conjunções</h2>
<ul>
...
<p><strong><a href="https://menalari.globasa.net/spa/lexi/fe">Fe</a></strong> é uma preposição polivalente com um
	significado geral e indefinido, que geralmente é traduzido como <em>de</em> (<em>relacionado com</em>). Pode ser
	usada como preposição de tempo (<em>em</em>), como preposição de lugar (apenas em locuções preposicionais, como
	visto abaixo), em locuções no início de frases, como alternativa aos adjetivos <strong>-li</strong>, e em casos em
	que nenhuma outra preposição é adequada.</p>
...
<p>(<strong>fe</strong>) <strong>ban mara</strong> - em certa ocasião, uma vez, alguma vez<br /> (<strong>fe</strong>)
	...
	<strong>Lunadin</strong> - (a) segunda-feira<br /> (<strong>fe</strong>) <strong>duli Lunadin</strong> - (às)
...
<p>As expressões <strong>fe nunya</strong> (no presente, atualmente, agora), <strong>fe leya</strong> (no passado,
	anteriormente) e <strong>fe xaya</strong> (no futuro, mais tarde, depois) geralmente permanecem intactas.</p>
...
<p><strong>To de Maria sen day.</strong><br /> A de Maria é grande.</p>
<p>O sufixo <strong>-su</strong> é adicionado aos pronomes para formar adjetivos possessivos. Da mesma forma, a
	...
	de substantivos. No entanto, ao contrário do uso de <strong>-su</strong> como sufixo em pronomes possessivos, a
...
<p>Se o substantivo é implícito, usa-se um pronome (<strong>te</strong>/<strong>to</strong> ou
	<strong>ete</strong>/<strong>oto</strong>):</p>
<p><strong>Maria su to sen day.</strong><br /> A de Maria é grande.</p>
...
<ul>
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/in">in</a></strong> - em, dentro de <ul>
			...
			<li><strong>fe inya</strong> - no interior, (para) dentro, por dentro</li>
		</ul>
	</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/bax">bax</a></strong> - sob, debaixo de, abaixo de <ul>
			...
			<li><strong>fe baxya</strong> - embaixo, por baixo</li>
		</ul>
	</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/cel">cel</a></strong> - a (<em>movimento</em>), para
		[<strong>cele</strong> - objetivo/propósito] <ul>
			...
			<li><strong>cel in</strong> - em (para dentro)</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/intre">intre</a></strong> - entre <ul>
			<li><strong>fe intreya</strong> - entremeio</li>
		</ul>
	</li>
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/ultra">ultra</a></strong> - além <ul>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/wey">wey</a></strong> - ao redor [<strong>jowey</strong>
		- arredores]</li>
...
<h2>Locuções preposicionais e conjuntivas</h2>
<ul>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/fronta">fronta</a></strong> - (<em>s</em>) frente,
		diante; (<em>v</em>) estar na frente (de) <ul>
			<li><strong>fe fronta</strong> - na frente</li>
			<li><strong>fe fronta de</strong> - na frente de</li>
		</ul>
	</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/tayti">tayti</a></strong> - (<em>s</em>) substituição,
		reposição; (<em>v</em>) substituir, repor <ul>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/folo">folo</a></strong> - seguir <ul>
			<li><strong>fe folo</strong> - em consequência, por conseguinte, então </li>
			<li><strong>fe folo fe</strong> - em consequência de, como resultado de </li>
			<li><strong>fe folo ki</strong> - (assim, de tal maneira) que</li>
		</ul>
	</li>
...
<ul>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/ton">ton</a></strong> - (junto) com
		[<strong>tongo</strong> - junto] <ul>
			<li><strong>nenton</strong> - sem, separado/à parte de </li>
		</ul>
	</li>
...
<ul>
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/dur">dur</a></strong> - durante, por <em>+ sintagma
		...
		<ul>
			...
			<li><strong>durki</strong> - enquanto <em>+ cláusula</em></li>
		</ul>
	</li>
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/fin-">fin-</a></strong> - (<em>prefixo</em>) até o fim
		[<strong>fini</strong> - terminar] <ul>
			...
			<li><strong>finki</strong> - (<em>conj</em>) até <em>+ cláusula</em></li>
		</ul>
	</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/mara">mara</a></strong> - vez, ocasião <ul>
			...
			<li>(<strong>fe</strong>) <strong>duli mara</strong> - às vezes, em ocasiões</li>
		</ul>
	</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/le">le</a></strong> - <em>partícula de tempo passado</em>
		<ul>
			...
			<li><strong>jaleli</strong> - o último, o mais recente</li>
			...
			<li><strong>lefe</strong> - antes de <em>+ sintagma nominal</em>; atrás</li>
			<li><strong>lefe o fe</strong> - para, até (no máximo)</li>
			<li><strong>lefe na</strong> - antes de <em>+ sintagma verbal</em></li>
			<li><strong>leki</strong> - antes que + <em>cláusula</em></li>
		</ul>
	</li>
	<li>**<a href="https://menalari.globasa.net/spa/lexi/xa">xa</a>
		<ul>
			...
			<li><strong>xaki</strong> - depois que + <em>cláusula</em></li>
		</ul>
	</li>
</ul>
...
<ul>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/eskaso">eskaso</a></strong> - escasso, escassamente,
		apenas, dificilmente</li>
...
<ul>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/hata">hata</a></strong> - até, mesmo <ul>
			<li><strong>no hata</strong> - nem mesmo</li>
			<li><strong>fe hataya</strong> - ainda assim, no entanto, apesar disso</li>
			...
			<li><strong>fe hataya ki</strong> - embora, apesar de que <em>+ cláusula</em></li>
		</ul>
	</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/sol">sol</a></strong> - só, somente
		[<strong>solo</strong> - sozinho/-a]</li>
</ul>
<h2>Comparação</h2>
<ul>
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/kom">kom</a></strong> - como (<em>comparável com</em>),
		que (<em>comparado com</em>) [<strong>kompara</strong> - comparação]</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/maxus">maxus</a></strong> - (<em>prep</em>) mais, além de
		<ul>
			<li><strong>maxusli</strong> - (<em>adj/adv</em>) positivo (+1, +2, etc.), além (disso)</li>
	...
	<li><strong><a href="https://menalari.globasa.net/spa/lexi/minus">minus</a></strong> - (<em>prep</em>) menos, exceto
		<ul>
			<li><strong>minusli</strong> - (<em>adj/adv</em>) negativo (-1, -2, etc.); com exceção disso, exceto por
				isso</li>
			<li><strong>fe minusya</strong> - com exceção disso, exceto por isso</li>
