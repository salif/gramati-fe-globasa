...
<ul>
	<li><strong>aw-:</strong> yok, uzakta <ul>
			<li><strong>awidi</strong> - ayrılmak, gitmek (<em>idi</em> - <em>gitmek</em>); <strong>awglu</strong> -
				(sonuna kadar) içip bitirmek (<em>glu</em> - <em>içmek</em>); <strong>awpel</strong> - kovmak
				(<em>pel</em> - <em>sürmek/itmek</em>)</li>
		</ul>
	</li>
	<li><strong>awto-:</strong> oto- (<em>otomatik, kendi kendine</em>) [<strong>awtomati</strong> - otomatik,
	...
	<li><strong>fin-:</strong> - sonu, sonuna kadar bitirmek <ul>
			<li><strong>findoxo</strong> - sonuna kadar okumak (<em>doxo</em> - <em>okumak</em>);
				<strong>finyam</strong> - her şeyi yiyip bitirmek (<em>yam</em> - <em>yemek</em>)</li>
		</ul>
	</li>
	<li><strong>fron-:</strong> ileriye doğru [<strong>fronta</strong> - alın, ön] <ul>
			<li><strong>fronkadam</strong> - ilerlemek (<em>kadam</em> - <em>adım</em>)</li>
		</ul>
	</li>
	<li><strong>ja-:</strong> hemen bitişik [<strong>jara</strong> - komşu] <ul>
			<li><strong>jale</strong> - az önce (<em>le - geçmiş zaman fiil eki</em>); <strong>jaxa</strong> - -ecek,
				-acak (<em>xa - gelecek zaman fiil eki</em>); <strong>jaledin</strong> - dün (<em>din - gün</em>);
				<strong>jaxadin</strong> - yarın (<em>din - gün</em>)</li>
		</ul>
	</li>
	<li><strong>nen-:</strong> -sız, -siz, -suz, -süz <ul>
			<li><strong>nenmuhim</strong> - önemsiz (<em>muhim</em> - <em>önemli</em>); <strong>nenkompleto</strong> -
				eksik (<em>kompleto</em> - <em>tam</em>); <strong>nenible</strong> - imkansız (<em>ible - mümkün</em>);
				<strong>okonenible</strong> - görünmez (<em>oko - görmek</em>); <strong>imanunenible</strong> -
				inanılmaz (<em>imanu - inanmak</em>)</li>
		</ul>
	</li>
...
<ul>
	<li><strong>-gon:</strong> -gen (<em>geometrik şekil</em>) [<strong>gona</strong> - açı] <ul>
...
<ul>
	...
	<li><strong>bax:</strong> altında, alt-, başkan yardımcısı <ul>
			<li><strong>baxgeoli</strong> - yeraltı (<em>geo - toprak, zemin</em>); <strong>baxpresidiyen</strong> -
				başkan yardımcısı (<em>presidiyen - başkan</em>)</li>
		</ul>
	</li>
...
<ul>
	<li><strong>bon:</strong> iyi; <em>bileşik kelimelerde:</em> iyi-, eu-, nesnel veya ahlaki olarak iyi/iyi <ul>
			<li><strong>bonata</strong> - hoş geldiniz (<em>ata</em> - <em>gelmek</em>); <strong>bonxanse</strong> - iyi
				...
				<em>sözcük</em>); <strong>bonmorcu</strong> - ötenazi (<em>morcu</em> - <em>ölüm</em>);
	...
	<li><strong>lao:</strong> yaşlı [<em>zıt</em> <strong>juni</strong>] <ul>
			<li><strong>laoatre</strong> - ata, dede (<em>atre</em> - <em>ebeveyn</em>); <strong>laonini</strong> -
...
<ul>
	...
	<li><strong>kaxa:</strong> kap <ul>
			<li><strong>anjenkaxa</strong> - kasa (<em>anjen</em> - <em>güvenli</em>); <strong>bezekaxa</strong> -
				arılık, kovan (<em>beze</em> - <em>arı</em>)</li>
		</ul>
	</li>
	...
	<li><strong>kumax:</strong> (parça) kumaş <ul>
			<li><strong>mesakumax</strong> - masa örtüsü (<em>mesa</em> - <em>masa</em>); <strong>nasakumax</strong> -
				mendil (<em>nasa</em> - <em>burun</em>); <strong>muntekumax</strong> - peçete (<em>munte</em> -
				<em>ağız</em>)</li>
		</ul>
	</li>
	<li><strong>lari:</strong> topluluk <ul>
			<li><strong>insanlari</strong> - insanlık (<em>insan</em> - <em>insan</em>); <strong>darsulari</strong> -
				kurs (<em>darsu</em> - <em>ders/sınıf</em>); <strong>mumulari</strong> - sığır sürüsü (<em>mumu</em> -
				<em>boğa/inek, sığır</em>); <strong>lexilari</strong> - kelime hazinesi (<em>lexi</em> -
				<em>kelime</em>); <strong>menalari</strong> - sözlük (<em>mena</em> - <em>anlam</em>, <em>tanım</em>);
				<strong>navilari</strong> - filo (<em>navi</em> - <em>gemi</em>); <strong>yumawlari</strong> - tüy
				örtüsü (<em>yumaw</em> - <em>tüy</em>)</li>
		</ul>
	</li>
	...
	<li><strong>yen:</strong> varlık (herhangi bir canlı varlık veya kişileştirilmiş nesne); <em>bileşik
			...
			<li><em>isim/fiil kökleri:</em> <strong>estudiyen</strong> - öğrenci (<em>estudi</em> - <em>öğrenmek</em>);
				...
				doktor (<em>medis</em> - <em>tedavi etmek, ilaç</em>); <strong>arteyen</strong> - sanatçı (<em>arte</em>
...
<p>Yukarıda <em>yarı ek</em> olarak listelenen isimler ve sıfatlar, bileşik kelimelerde en sık kullanılan içerik
	kelimeleridir. Bununla birlikte, liste kapsamlı değildir, çünkü <em>herhangi bir</em> içerik kelimesi, bileşik
	kelimeler türetmek için serbestçe kullanılabilir. Herhangi bir bileşik kelime içindeki iki morfemi ayırmak için
	isteğe bağlı olarak bir tire eklenebilir. Bununla birlikte, bir pratik kural olarak, tirelerin yalnızca aşağıdaki
...
<p><strong>Sudekorea</strong> veya <strong>SudeKorea</strong> veya <strong>Sude-Korea</strong> - Güney Kore</p>
...
<p>Alternatif olarak, tanımlayıcı kelime, <strong>-li</strong>'nin eşdeğeri olarak <strong>fe</strong> ile bir edat
	öbeğinde kullanılabilir. Aslında, bileşik kelime zaten <strong>xencudin</strong>
