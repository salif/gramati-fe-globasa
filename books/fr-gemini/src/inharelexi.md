<h1>Mots de contenu : Noms, verbes, adjectifs et adverbes</h1>
<p>
</p>
<h2>Noms</h2>
<p>Les noms en globasa ne font pas de distinction entre les formes singulières et plurielles.</p>
<ul>
	<li><strong>maux</strong> - rat, rats</li>
	<li><strong>kalamu</strong> - stylo(s)</li>
</ul>
<p>Les noms en globasa n'ont pas d'articles définis ou indéfinis.</p>
<ul>
	<li><strong>janela</strong> - (une) fenêtre, (la/les) fenêtre(s)</li>
</ul>
<p>S'il est nécessaire de souligner la définitude, on peut utiliser <strong>hin</strong> (ce/-tte(s)) ou
	<strong>den</strong> (ce/-tte(s) là).</p>
<ul>
...
<p>S'il est nécessaire de souligner la singularité, on peut utiliser <strong>un</strong> (un/-e).</p>
<ul>
	<li><strong>un denta</strong> - une dent</li>
	<li><strong>hin un denta</strong> - cette dent (singulière), la dent (singulière)</li>
</ul>
<p>S'il est nécessaire de souligner la pluralité, on peut utiliser <strong>plu</strong> (plusieurs).</p>
<ul>
	<li><strong>plu pingo</strong> - (plusieurs) pommes</li>
	<li><strong>den plu pingo</strong> - ces (plusieurs) pommes, les pommes</li>
</ul>
<h3>Genre</h3>
<p>En globasa, les noms désignant des personnes et des animaux sont généralement de genre neutre.</p>
<ul>
	<li><strong>ixu</strong> - adulte (homme, femme) </li>
	<li><strong>nini</strong> - enfant, garçon/fille </li>
	<li><strong>gami</strong> - conjoint(e), époux/épouse </li>
	<li><strong>mumu</strong> - taureau, vache</li>
</ul>
<p>S'il est nécessaire de souligner le genre, les adjectifs <strong>fem</strong> (féminin) et <strong>man</strong>
...
<p><em>Étymologie de <strong>man</strong> : mandarin (男 “nán”), français (masculin), espagnol (masculino), anglais
		(masculine), allemand (männlich), hindi (मर्दाना “mardana”), persan (مردانه “mardane”)</em></p>
...
<p><em>Remarque : Le mot de genre neutre pour parent(s) est <strong>atre</strong>. Le mot de genre neutre pour
		maman/papa est <strong>mapa</strong>.</em></p>
<h3>Noms en début de phrase</h3>
<p><strong>Fe</strong> est souvent utilisé dans les phrases commençant par des noms.</p>
<ul>
	<li><strong>Fe fato</strong> - En fait, En réalité </li>
	<li><strong>Fe fini</strong> - Enfin, Finalement </li>
	<li><strong>Fe bonxanse</strong> - Par chance, Heureusement </li>
	<li><strong>Fe asif</strong> - Malheureusement </li>
	<li><strong>Fe onxala</strong> - Si seulement </li>
	<li><strong>Fe folo</strong> - Par conséquent, Donc </li>
	<li><strong>Fe misal</strong> - Par exemple </li>
	<li><strong>Fe xugwan</strong> - Généralement, D'habitude </li>
...
<p>La particule <strong>di</strong> peut être utilisée facultativement pour marquer les mots spécifiques à une culture
	et les noms propres qui ont une <em>forme identique</em> à des mots ordinaires déjà établis en globasa. </p>
<ul>
	<li><strong>soho</strong> - réciproque, mutuel <ul>
			<li><strong>(di) Soho</strong> - Soho (quartier de la ville de New York)</li>
		</ul>
	</li>
</ul>
<h3>Particule <em>ci</em> : Tendresse et affection</h3>
<p>Un nom ou un nom propre peut être suivi de la particule <strong>ci</strong> pour exprimer la tendresse ou
	l'affection.</p>
<ul>
	<li><strong>mama</strong> - maman <ul>
			<li><strong>mama ci</strong> - maman chérie</li>
		</ul>
	</li>
	<li><strong>nini</strong> - enfant <ul>
			<li><strong>nini ci</strong> - petit enfant</li>
		</ul>
	</li>
...
<h3>Honorifiques : <em>Gao</em> et <em>Kef</em></h3>
<p>L'adjectif <strong>gao</strong> (haut) et le nom <strong>kef</strong> (chef) peuvent être utilisés comme
	honorifiques. </p>
<ul>
	...
	<li><strong>papa</strong> - papa <ul>
			<li><strong>kef papa</strong> - chef </li>
		</ul>
	</li>
</ul>
<h3>Noms/Verbes</h3>
<p>En globasa, les noms/verbes sont des mots qui peuvent fonctionner soit comme un nom, soit comme un verbe.</p>
<ul>
...
<p>La comparaison des noms/verbes est exprimée de la manière suivante : <strong>máximo</strong> (<em>plus</em>),
...
<ul>
	<li><strong>max te/to kom...</strong> - plus (d'eux) que...</li>
	<li><strong>min te/to kom...</strong> - moins (d'eux) que...</li>
</ul>
<p><strong>Mi hare max to kom yu.</strong><br /> J'en ai plus que toi.</p>
<p><strong>Yu hare min to kom mi.</strong><br /> Tu en as moins que moi.</p>
<ul>
...
<p><strong>Yu yam denkwanti to kom mi.</strong><br /> Tu manges autant (de cela) que moi.</p>
<p>Avec les verbes :</p>
<ul>
...
<p><strong>Folki mi max doxo, mi max jixi.</strong><br /> Plus je lis, plus je sais.</p>
<p>L'ordre de ces phrases peut être inversé :</p>
<p><strong>Mi max jixi, folki mi max doxo.</strong><br /> Je sais plus, plus je lis.</p>
...
<p>Les verbes sont définis dans le dictionnaire comme <em>auxiliaires</em>, <em>copulatifs</em>, <em>transitifs</em>,
	<em>intransitifs</em> ou <em>ambitransitifs</em>.</p>
<h4>Verbes auxiliaires</h4>
<p>Les <em>verbes auxiliaires</em> sont immédiatement suivis d'un autre verbe, qui peut être omis. En globasa, il n'y a
	que trois verbes auxiliaires : <strong>abil</strong> (pouvoir), <strong>ingay</strong> (devrait),
	<strong>musi</strong> (devoir, falloir).</p>
<h4>Verbes copulatifs</h4>
<p>Les <em>verbes copulatifs</em> relient le sujet à son complément. Il y a actuellement 12 verbes copulatifs :
	<strong>sen</strong> (être), <strong>xorsen</strong> (devenir), <strong>sencu</strong> (devenir),
	<strong>sengi</strong> (faire que ce soit), <strong>kwasisen</strong> (paraître), <strong>okocu</strong> (avoir
	l'air), <strong>orecu</strong> (être entendu), <strong>nasacu</strong> (sentir), <strong>xetocu</strong> (avoir le
	goût), <strong>pifucu</strong> (se sentir au toucher), <strong>hisicu</strong> (se sentir physiquement),
	<strong>ganjoncu</strong> (se sentir émotionnellement).</p>
...
<p>Les <em>verbes transitifs</em> prennent un complément d'objet direct : <strong>haja</strong> (avoir besoin),
	<strong>bujo</strong> (attraper, capturer), <strong>gibe</strong> (donner). Cependant, certains <em>verbes
		transitifs</em> omettent parfois ou fréquemment le complément d'objet direct : <strong>doxo</strong> (lire),
	<strong>yam</strong> (manger).</p>
...
<p>Les <em>verbes intransitifs</em> ne prennent pas de complément d'objet direct : <strong>idi</strong> (aller),
	<strong>konduta</strong> (se comporter), <strong>loka</strong> (être situé). Cependant, certains verbes étiquetés
	comme intransitifs peuvent être utilisés comme <em>verbes transitifs</em> avec le même nom/verbe répété comme
	complément d'objet direct, ou également avec un nom propre ou une catégorie de ce nom.</p>
<p><strong>Mi le somno (lungo somno).</strong><br /> J'ai dormi (un long sommeil).</p>
<p><strong>Yu le haha (sotipul haha).</strong><br /> Tu as ri (un grand rire).</p>
<p><strong>Te xa lala (Hox Xencudin).</strong><br /> Elle chantera (Joyeux anniversaire).</p>
<p><strong>Te danse (tango).</strong><br /> Il danse (le tango).</p>
<p>En théorie, tous les autres <em>verbes intransitifs</em> peuvent être utilisés de manière transitive avec
	l'utilisation optionnelle de <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong>, bien qu'il puisse
	être préférable d'appliquer <strong>-gi</strong> dans la plupart des cas.</p>
<p><strong>Kam yu fley(gi) hawanavi?</strong><br /> Est-ce que tu pilotes des avions ?</p>
<p><strong>Mi xa sampo(gi) bwaw fe axam.</strong><br /> Je promènerai le chien le soir.</p>
...
<p>Les <a href="https://en.wikipedia.org/wiki/Ambitransitive_verb#Patientive"><em>verbes ambitransitifs</em></a> en
	globasa sont des verbes pour lesquels à la fois le sujet du sens intransitif et le complément d'objet direct du sens
	transitif subissent la même action ou le même état du verbe. Le sens intransitif de ces verbes peut facultativement
	se voir appliquer <strong><a href="./inharelexi.html#xafefikso_-cu">-cu</a></strong> et le sens transitif peut
	facultativement se voir appliquer <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong>. Voir
	<strong>-cu</strong> et <strong>-gi</strong> sous <em>Affixes courants</em>. Il y a quatre sous-catégories de
	<em>verbes ambitransitifs</em> : <em>verbes de sentiment</em>, <em>verbes d'état</em>, <em>verbes sans agent</em>,
	et <em>verbes de position/emplacement ou mouvement</em>.</p>
...
<p>Les <em>verbes ambitransitifs</em> qui dénotent un sentiment signifient <em>ressentir [racine nominale] ou faire
		ressentir [racine nominale]</em>. Notez que le sens intransitif peut également être exprimé par une phrase
	copulative et un adjectif : <strong>sen</strong> <em>[racine nominale]</em><strong>-do</strong>. Voir <strong><a
			href="./inharelexi.html#xafefikso_-do">-do</a></strong> sous <em>Affixes courants</em>. </p>
<ul>
	<li><strong>interes(cu)</strong> - être/se sentir intéressé (<em>ressentir l'intérêt</em>)<br />
		<strong>interes(gi)</strong> - intéresser (<em>faire ressentir l'intérêt</em>)
	</li>
</ul>
...
<ul>
	<li><strong>pilo(cu)</strong> - être/se sentir fatigué (<em>ressentir la fatigue</em>)<br />
		<strong>pilo(gi)</strong> - fatiguer (<em>faire ressentir la fatigue</em>)
	</li>
</ul>
...
<p><strong>Mi le interes tem basalogi lefe multi nyan.</strong><br /> J'étais intéressé par la linguistique il y a de
	nombreuses années.</p>
<p><strong>Te le pilo dur na ergo.</strong><br /> Elle était fatiguée en travaillant.</p>
<p>Comparer avec :</p>
...
<p><strong>Te le xorpilo dur na ergo.</strong><br /> Elle s'est fatiguée en travaillant.</p>
<p><em>Verbes d'état</em> </p>
<p><em>Les verbes ambitransitifs d'état</em> sont similaires aux <em>verbes de sentiment</em>. Ce sont des <em>noms
		d'état</em> qui peuvent être utilisés comme <em>verbes ambitransitifs</em> et qui signifient <em>avoir [racine
		nominale] ou faire avoir [racine nominale]</em>. Notez que le sens intransitif peut également être exprimé par
	une phrase copulative et un adjectif : <strong>sen</strong> <em>[racine nominale]</em><strong>-pul</strong>. Voir
	<strong><a href="./inharelexi.html#xafefikso_-pul">-pul</a></strong> sous <em>Affixes courants</em>.</p>
<ul>
	<li><strong>termo(cu)</strong> - avoir chaud (<em>avoir de la chaleur</em>)<br />
		<strong>termo(gi)</strong> - chauffer (<em>faire avoir de la chaleur</em>)
	</li>
</ul>
...
<ul>
	<li><strong>cinon(cu)</strong> - être intelligent (<em>avoir de l'intelligence</em>)<br />
		<strong>cinon(gi)</strong> - rendre intelligent (<em>faire avoir de l'intelligence</em>)
	</li>
</ul>
...
<ul>
	<li><strong>talento(cu)</strong> - être talentueux (<em>avoir du talent</em>)<br />
		<strong>talento(gi)</strong> - rendre talentueux (<em>faire avoir du talent</em>)
	</li>
</ul>
...
<p>Le préfixe <strong>xor-</strong> peut être utilisé avec les <em>verbes d'état</em> pour exprimer la distinction
	suivante :</p>
<p><strong>Jaledin le termo.</strong> = <strong>Jaledin le sen termopul.</strong> Hier, il faisait chaud.</p>
<p>Comparer avec :</p>
<p><strong>To le xortermo fe midinuru. </strong> = <strong>To le xorsen/sencu termopul fe midinuru.</strong><br /> Il a
	commencé à faire chaud à midi.</p>
<p><em>Verbes sans agent</em></p>
<p>Dans le sens intransitif des <em>verbes ambitransitifs sans agent</em>, l'action est quelque chose qui arrive au
	sujet plutôt que quelque chose que le sujet accomplit.</p>
<ul>
	<li><strong>kasiru(cu)</strong> - casser (<em>se casser</em>)<br />
		<strong>kasiru(gi)</strong> - casser (<em>cause de casse</em>)
	</li>
</ul>
...
<p><em>Verbes de position/emplacement ou mouvement</em></p>
<p>Dans le sens intransitif des <em>verbes ambitransitifs de position/emplacement ou mouvement</em>, le sujet est à la
	fois l'agent et le patient.</p>
<ul>
	<li><strong>esto(cu)</strong> - s'arrêter (<em>s'arrêter</em>)<br />
		<strong>esto(gi)</strong> - arrêter (<em>faire arrêter</em>)
	</li>
</ul>
<p><strong>Am esto(cu)!</strong><br /> Arrête-toi !</p>
...
<p><strong>Mi le harka(gi) yusu kursi.</strong><br /> J'ai déplacé ta chaise.</p>
<p>Les trois verbes de cette sous-catégorie ci-dessous utilisent également <strong>xor-</strong> comme vu précédemment
	pour faire une distinction similaire de sens :</p>
<ul>
	<li><strong>side(cu)</strong> - être assis, s'asseoir<br />
		<strong>side(gi)</strong> - asseoir
	</li>
</ul>
<p><strong>Te side(cu) fe fronta de darsu-kamer.</strong><br /> Il est assis devant la classe. </p>
<p><strong>Am side(gi) bebe per hin kursi.</strong><br /> Assieds le bébé sur cette chaise.</p>
<ul>
	<li><strong>xorside(cu)</strong> - s'asseoir</li>
</ul>
<p><strong>Am xorside per sofa.</strong><br /> Assieds-toi sur le canapé.</p>
<ul>
	<li><strong>estay(cu)</strong> - être debout, se tenir debout<br />
		<strong>estay(gi)</strong> - mettre debout, lever, dresser
	</li>
</ul>
<p><strong>Yu estay(cu) per misu kamisa.</strong><br /> Tu es debout sur ma chemise.</p>
<p><strong>Am estay(gi) bebe.</strong><br /> Mets le bébé debout.</p>
<ul>
	<li><strong>xorestay(cu)</strong> - se mettre debout</li>
</ul>
<p><strong>Mi le xorestay denwatu hu te le inidi kamer.</strong><br /> Je me suis levé quand elle est entrée dans la
	pièce.</p>
<ul>
	<li><strong>leta(cu)</strong> - être couché, s'allonger, gésir<br />
		<strong>leta(gi)</strong> - coucher
	</li>
</ul>
<p><strong>Myaw leta(cu) per dixan.</strong><br /> Le chat est allongé sur le sol.</p>
<p><strong>Mi xa leta(gi) bwaw per bistar.</strong><br /> Je vais coucher le chien dans le lit.</p>
<ul>
	<li><strong>xorleta(cu)</strong> - s'allonger</li>
</ul>
<p><strong>Am no xorleta per sofa.</strong><br /> Ne t'allonge pas sur le canapé. </p>
<h2>Adjectifs/Adverbes</h2>
<p>En globasa, les adjectifs et les <em>adverbes qui modifient les verbes</em> ont une forme identique.</p>
<ul>
...
<p>Les adverbes peuvent également apparaître après le verbe, mais précédés des compléments d'objet directs et indirects,
	s'il y en a : Sujet - Verbe - (Compléments d'objet directs et indirects) - Adverbe.</p>
...
<p>Les adverbes peuvent également être déplacés au début de la phrase, à condition qu'une pause claire soit faite en
	utilisant une virgule pour séparer le reste de la phrase. Sans la pause, l'adjectif/adverbe pourrait être interprété
	à tort comme modifiant le sujet.</p>
...
<p>Voici des adjectifs/adverbes couramment utilisés en début de phrase, suivis d'une pause claire avant le reste de la
	phrase.</p>
<ul>
	<li><strong>Ripul</strong> - De nouveau, Encore une fois </li>
	<li><strong>Ible</strong> - Peut-être, Probablement </li>
	...
	<li><strong>Umumi</strong> - En général </li>
...
<h3>Comparaison des adjectifs/adverbes</h3>
<p>La comparaison des adjectifs/adverbes est exprimée comme suit en utilisant les mots <strong>maxmo</strong>
	(<em>plus</em>), <strong>minmo</strong> (<em>moins</em>), <strong>denmo</strong> (<em>comme</em>),
	<strong>kom</strong> (<em>comme, que</em>).</p>
<ul>
...
<p>Pour exprimer <em>le/la plus</em> et <em>le/la moins</em>, le globasa utilise <strong>maxim... te/to</strong> et
...
<p>Pour exprimer <em>plus/moins... plus/moins...</em>, le globasa utilise <strong>folki maxmo/minmo,
		maxmo/minmo</strong>.</p>
<ul>
	<li><strong>folki (to sen) maxmo neo, (to sen) maxmo bon</strong> - plus c'est neuf, mieux c'est</li>
</ul>
<h2>Mots verbe/adjectif-adverbe</h2>
<p>En plus des mots nom/verbe et adjectif/adverbe, le globasa a une troisième classe de mots : les <em>mots
...
<h2>Affixes courants</h2>
<h3>Suffixe nominal -ya <span id="xafefikso_-ya"></span></h3>
<p>Le suffixe <strong>-ya</strong> a une variété de fonctions utiles et est équivalent au suffixe <em>-ité</em> en
	français.</p>
<ol>
	<li>Les noms abstraits sont dérivés d'adjectifs/adverbes en ajoutant <strong>-ya</strong>.</li>
</ol>
<ul>
	<li>
...
<ol start="2">
	<li>Le suffixe <strong>-ya</strong> est utilisé pour dériver des noms abstraits et non dénombrables à partir d'une
...
<p>Le suffixe <strong>-ya</strong> signifie <em>-ité</em> lorsqu'il est joint à des noms qui dénotent des relations.</p>
<ul>
	<li>
...
<p>Dans certains cas, le nom concret ou dénombrable est utilisé comme verbe et le nom abstrait ou non dénombrable est
	dérivé à l'aide de <strong>-ya</strong> et fonctionne comme la contrepartie du verbe.</p>
<ul>
	<li>
	...
	<li>
		<p><strong>turi</strong> - voyage (<em>nom dénombrable</em>), voyager (<em>verbe</em>)<br />
			<strong>turiya</strong> - tourisme (<em>nom non dénombrable</em>)
		</p>
	</li>
</ul>
<p>De même, les parties du corps associées aux cinq sens dénotent l'action associée (<em>verbe</em>), tandis que
...
<ul>
	...
	<li>
		<p><strong>xeto</strong> - langue (<em>nom concret</em>), avoir le goût de (<em>verbe</em>)<br />
			<strong>xetoya</strong> - goût <em>ou</em> sens du goût (<em>nom abstrait</em>)
		</p>
	</li>
	<li>
...
<ol start="3">
	<li>
		<p>Les prépositions deviennent des noms/verbes en utilisant le suffixe <strong>-ya</strong>. Voir <a
...
<ul>
	<li><strong>dudanse</strong> - l'action de danser, la danse</li>
	<li><strong>dulala</strong> - l'action de chanter, le chant</li>
</ul>
...
<h4>Noms</h4>
<p>Le suffixe <strong>-gi</strong> signifie <em>faire, transformer en</em> lorsqu'il est ajouté à des noms. </p>
<ul>
	<li>
...
<h4>Verbes</h4>
<p>Le suffixe <strong>-gi</strong> est également utilisé pour transformer les verbes intransitifs, transitifs ou
	ambitransitifs agentifs en verbes causatifs (comme vu ci-dessous) ou est utilisé facultativement sur les verbes
	ambitransitifs patientifs (comme vu ci-dessus, dans <a href="./inharelexi.html#falelexili_klase">Catégories
		verbales</a>).</p>
<ul>
	<li>
		<p><strong>haha</strong> - rire<br />
			<strong>hahagi</strong> - faire rire (<em>faire rire, causer/provoquer le rire</em>)
		</p>
	</li>
	<li>
		<p><strong>yam</strong> - manger<br />
			<strong>yamgi</strong> - nourrir (<em>faire manger</em>)
		</p>
	</li>
</ul>
<h3>Suffixe nominal/verbal -cu <span id="xafefikso_-cu"></span></h3>
<p>Le suffixe <strong>-cu</strong> peut être appliqué aux adjectifs et aux noms, en plus des verbes, comme vu
	précédemment dans <a href="./inharelexi.html#falelexili_klase">Catégories de verbes</a>.</p>
<h4>Adjectifs</h4>
...
<ul>
	...
	<li>
		<p><strong>mor</strong> - mort<br />
			<strong>morcu</strong> - mourir (<em>devenir un mort</em>)
		</p>
	</li>
</ul>
<h4>Noms</h4>
<p>Le suffixe <strong>-cu</strong> signifie <em>devenir</em> lorsqu'il est ajouté à des noms. </p>
<ul>
	<li>
		<p><strong>zombi</strong> - zombie<br />
	...
	<li>
		<p><strong>ixu</strong> - adulte (humain)<br />
			<strong>ixucu</strong> - devenir un adulte, atteindre la maturité
		</p>
	</li>
</ul>
...
<h3>Suffixe des adjectifs/adverbes -li <span id="xafefikso_-li"></span></h3>
<p>En globasa, les adjectifs/adverbes sont dérivés de noms à l'aide de divers suffixes. Voir la liste complète des
...
<p>Le suffixe <strong>-li</strong> est également utilisé pour dériver des adjectifs/adverbes de mots fonctionnels. Voir
	<a href="./gramatilexi.html">Mots fonctionnels</a>.</p>
...
<h3>Suffixe des adjectifs/adverbes -pul <span id="xafefikso_-pul"></span></h3>
<p>Le mot <strong>pul</strong> signifie <em>plein</em>. Cependant, en tant que suffixe, <strong>-pul</strong> signifie
	<em>avec suffisamment ou plus qu'assez</em>.</p>
<ul>
	<li>
		<p><strong>humor</strong> - humour <strong>humorpul</strong> - drôle, amusant</p>
	</li>
	<li>
...
<p>Le suffixe <strong>-ne</strong> signifie <em>dans un état ou un processus actif de</em> et est utilisé pour dériver
	ce que l'on appelle en globasa les <em>adjectifs actifs</em>.</p>
<ul>
	<li>
	...
	<li>
		<p><strong>anda</strong> - marcher<br />
			<strong><em>andane</em> moryen</strong> - mort <em>ambulante</em> (mort-vivant)
		</p>
	</li>
	<li>
		<p><strong>danse</strong> - danser<br />
			<strong><em>dansene</em> uma</strong> - cheval <em>danseur</em>
		</p>
	</li>
	<li>
	...
	<li>
		<p><strong>amusa</strong> - divertir<br />
			<strong><em>amusane</em> filme</strong> - film <em>divertissant</em>
		</p>
	</li>
</ul>
...
<p>Les adjectifs actifs qui apparaissent au début d'une phrase, et qui équivalent au <em>gérondif</em> en français,
...
<p><strong><em>Fe na doxo,</em> nini le xorsomno.</strong><br />
	<em>Lors de la lecture,</em> l'enfant s'est endormi.
</p>
<p><em>ou</em> </p>
<p><strong><em>Dur na doxo,</em> nini le xorsomno.</strong><br />
	<em>Pendant qu'il lisait,</em> l'enfant s'est endormi.
</p>
<p>Cette construction est particulièrement utile lorsque la phrase inclut un complément d'objet direct, car,
...
<p>Les adjectifs actifs peuvent être transformés en adjectifs passifs en ajoutant le préfixe passif <strong>be-</strong>
	pour donner naissance à ce qui est connu en globasa comme des "adjectifs actifs passifs" (ou "adjectifs passifs").
	Il n'existe pas d'équivalent exact en français pour les <em>adjectifs passifs</em>, mais ils sont mieux compris
	comme la forme passive exacte de l'<em>adjectif actif</em>. </p>
<ul>
	<li><strong>belalane melodi</strong> - mélodie qui est chantée ou en train d'être chantée</li>
	<li><strong>belubine doste</strong> - ami bien-aimé ou ami qui est aimé</li>
</ul>
<h3>Adjectifs inactifs : suffixe -do <span id="xafefikso_-do"></span></h3>
<p>Le suffixe <strong>-do</strong> signifie <em>dans un état inactif de</em>. Les mots avec ce suffixe sont connus en
	globasa comme des <em>adjectifs inactifs</em> et sont généralement traduits comme le <em>participe passé</em> en
	français. Cependant, contrairement au français, les adjectifs inactifs ne sont pas utilisés pour générer des formes
	verbales <em>parfaites</em> ou <em>passives</em> (<em>j'ai travaillé</em>, <em>a été volé</em>, etc.). Ils
	fonctionnent uniquement comme des adjectifs.</p>
<p>Il est à noter que, techniquement parlant, le suffixe <strong>-do</strong> est ajouté à l'aspect <em>nominal</em> des
	noms/verbes. Pour cette raison, <strong>-do</strong> peut être ajouté aux noms/verbes, aux verbes transitifs,
	intransitifs ou ambitransitifs.</p>
<h4>Avec les verbes transitifs</h4>
<ul>
	<li><strong>hajado ergo</strong> - travail nécessaire (<em>dans un état de besoin</em>) </li>
	<li><strong>bujodo morgiyen</strong> - assassin capturé (<em>dans un état de capture</em>)</li>
</ul>
<h4>Avec les verbes intransitifs</h4>
<ul>
	<li><strong>Uncudo Nasyonlari</strong> - Nations unies (<em>dans un état d'union</em>) </li>
	<li><strong>awcudo fleytora</strong> - avion disparu (<em>dans un état de disparition</em>) </li>
</ul>
<h4>Avec les verbes ambitransitifs</h4>
<ul>
	<li><strong>kasirudo janela</strong> - fenêtre cassée (<em>dans un état de rupture</em>) </li>
	<li><strong>klosido dwer</strong> - porte fermée (<em>dans un état de fermeture</em>) </li>
</ul>
...
<ul>
	<li>
		<p><strong>perfeto blue oko</strong> - yeux bleus parfaits (<em>yeux bleus qui sont parfaits</em>)<br />
			<strong>perfetomo blue oko</strong> - yeux parfaitement bleus
		</p>
	</li>
	<li>
		<p><strong>naturali syahe tofa</strong> - cheveux noirs naturels (<em>pas une perruque</em>)<br />
			<strong>naturalimo syahe tofa</strong> - cheveux naturellement noirs (<em>non teints</em>)
		</p>
	</li>
	<li>
