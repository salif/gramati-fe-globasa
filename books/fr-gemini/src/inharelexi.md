...
<p>Les verbes sont définis dans le dictionnaire comme <em>auxiliaires</em>, <em>copulatifs</em>, <em>transitifs</em>,
	<em>intransitifs</em> ou <em>ambitransitifs</em>. Les suffixes apparaissant dans cette section
	(<strong>-cu</strong>, <strong>-gi</strong>, <strong>-ne</strong>, <strong>-do</strong>, <strong>-pul</strong>) sont
	expliqués dans la section des <a href="./inharelexi.html#pimpan_fikso"><em>Affixes courants</em></a>. Le préfixe
	<strong>xor-</strong> est expliqué dans la section <a href="./lexikostrui.html#lefefikso"><em>Formation des mots :
			Préfixes</em></a>.</p>
...
<p>Les <em>verbes auxiliaires</em> sont suivis immédiatement d'un autre verbe, qui peut être omis. En globasa, il n'y a
	que trois verbes auxiliaires : <strong>abil</strong> (pouvoir), <strong>ingay</strong> (devoir [conditionnel]),
	<strong>musi</strong> (devoir, être obligé de).</p>
...
<p>Les <em>verbes copulatifs</em> relient le sujet à son complément. Il y a actuellement 12 verbes copulatifs :
	...
	<strong>sengi</strong> (faire être), <strong>kwasisen</strong> (sembler), <strong>okocu</strong> (avoir l'air),
	<strong>orecu</strong> (s'entendre [son]), <strong>nasacu</strong> (sentir [odeur]), <strong>xetocu</strong> (avoir
	le goût de), <strong>pifucu</strong> (se sentir au toucher), <strong>hisicu</strong> (se sentir physiquement ou
	émotionnellement), <strong>ganjoncu</strong> (se sentir émotionnellement).</p>
<h4>Verbes transitifs</h4>
<p>Les <em>verbes transitifs</em> prennent un complément d'objet direct : <strong>haja</strong> (avoir besoin de),
	...
	<strong>yam</strong> (manger), <strong>lala</strong> (chanter), etc.</p>
<p>Certains <em>verbes transitifs</em> apparaissent presque toujours sans complément d'objet direct :
	<strong>somno</strong> (dormir), <strong>haha</strong> (rire), <strong>pawbu</strong> (courir),
	<strong>fley</strong> (voler), etc.</p>
<p><strong>Mi le somno (lungo somno).</strong><br /> J'ai dormi (d'un long sommeil).</p>
<p><strong>Yu le haha (sotipul haha).</strong><br /> Tu as ri (d'un rire bruyant).</p>
<p>Le suffixe <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong> peut s'appliquer aux verbes transitifs
	avec le sens <em>faire [verbe racine]</em>.</p>
<p><strong>Kam yu fleygi hawanavi?</strong><br /> Pilotes-tu des avions ?</p>
...
<p>Les <em>verbes intransitifs</em> ne prennent pas de complément d'objet direct : <strong>idi</strong> (aller),
	...
	<strong>garaku</strong> (se noyer, couler). Les verbes intransitifs peuvent devenir des verbes transitifs avec
	l'utilisation facultative de <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong> en présence d'un
	complément d'objet direct.</p>
<ul>
	<li><strong>garaku</strong> - se noyer, couler<br />
		<strong>garaku(gi)</strong> - noyer, faire couler
	</li>
</ul>
<p><strong>Navikef le garaku.</strong><br /> Le capitaine s'est noyé.</p>
...
<p>Cependant, dans la dérivation des mots, <strong><a href="./inharelexi.html#xafefikso_-gi">-gi</a></strong> est
	obligatoire. Comparez les adjectifs dérivés suivants avec <strong>garaku</strong> et le suffixe <strong><a
			href="./inharelexi.html#xafefikso_-ne">-ne</a></strong>.</p>
<p><strong>garakune navikef</strong> - le capitaine en train de se noyer</p>
<p><strong>garakugine navikef</strong> - le capitaine en train de couler (le bateau)</p>
...
<p>Il existe quatre sous-catégories de <em>verbes ambitransitifs</em> : <em>verbes de sentiment</em>, <em>verbes
		d'état</em>, <em>verbes sans agent</em>, et <em>verbes de position/localisation ou de mouvement</em>.</p>
...
<p><strong>Mi interes(cu) tem basalogi.</strong><br /> Je m'intéresse à la linguistique.</p>
...
<p>Le préfixe <strong>xor-</strong> peut être utilisé avec les <em>verbes de sentiment</em> pour exprimer la distinction
	suivante :</p>
<p><strong>Mi le interes tem basalogi lefe multi nyan.</strong><br /> Je m'intéressais à la linguistique il y a
	plusieurs années.</p>
...
<p><em>Les verbes ambitransitifs d'état</em> sont similaires aux <em>verbes de sentiment</em>. Ce sont des <em>noms
	...
	une phrase copulative et adjectivale : <strong>sen</strong> <em>[racine nominale]</em><strong><a
...
<p>Le préfixe <strong>xor-</strong> peut être utilisé avec les <em>verbes d'état</em> pour exprimer la distinction
	suivante :</p>
<p><strong>Jaledin le termo.</strong> = <strong>Jaledin le sen termopul.</strong> Il a fait chaud hier.</p>
<p>Comparer avec :</p>
...
<ul>
	<li><strong>kasiru(cu)</strong> - se casser (<em>se briser</em>)<br />
		<strong>kasiru(gi)</strong> - casser (<em>causer la rupture</em>)
	</li>
</ul>
...
<ul>
	<li><strong>fini(cu)</strong> - se terminer, finir (<em>arriver à sa fin</em>)<br />
		<strong>fini(gi)</strong> - terminer, mettre fin à (<em>faire arriver à sa fin</em>)
	</li>
</ul>
...
<p><em>Verbes de position/localisation ou de mouvement</em></p>
<p>Dans le sens intransitif des <em>verbes ambitransitifs de position/localisation ou de mouvement</em>, le sujet est à
	la fois agent et patient.</p>
<ul>
	<li><strong>esto(cu)</strong> - s'arrêter (<em>faire un arrêt</em>)<br />
		<strong>esto(gi)</strong> - arrêter (<em>faire arrêter ou faire faire un arrêt</em>)
	</li>
</ul>
...
<ul>
	<li><strong>buka(cu)</strong> - s'ouvrir (<em>devenir ouvert</em>)<br />
...
<p>Dans la dérivation des mots, les verbes <em>ambitransitifs</em> fonctionnent comme des <em>verbes transitifs</em>
	...
	verbe est utilisé dans la dérivation des mots, le suffixe <strong><a
			href="./inharelexi.html#xafefikso_-cu">-cu</a></strong> doit être appliqué. Comparez les adjectifs dérivés
	suivants avec <strong>buka</strong> et le suffixe <strong><a href="./inharelexi.html#xafefikso_-ne">-ne</a></strong>
	:</p>
...
<h2>Affixes courants <span id="pimpan_fikso"></span></h2>
...
<h4>Verbes</h4>
<p>Le suffixe <strong>-gi</strong> est également utilisé pour transformer des verbes intransitifs et transitifs en
	verbes causatifs, ou il est utilisé facultativement sur des verbes ambitransitifs, comme vu précédemment dans <a
...
<p>Le suffixe <strong>-cu</strong> peut s'appliquer aux adjectifs et aux noms, en plus des verbes, comme vu précédemment
	dans <a href="./inharelexi.html#falelexili_klase"><em>Catégories de verbes</em></a>.</p>
<h4>Adjectifs</h4>
