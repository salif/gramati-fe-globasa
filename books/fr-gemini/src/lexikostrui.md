<h1>Formation de mots</h1>
<p>
</p>
<h2>Classe de mot dans les mots à affixes</h2>
<p>Les préfixes ne modifient pas la classe de mot dans les mots à affixes. En revanche, les suffixes modifient bien la
	classe de mot, c'est pourquoi ils sont définis comme des suffixes <em>adjectif/adverbe</em> ou des suffixes
	<em>nom/verbe</em>.</p>
...
<ul>
	...
	<li><strong><a href="./inharelexi.html#xafefikso_-mo">-mo</a>:</strong> transforme les adjectifs en <em>adverbes
			modificateurs d'adjectifs/adverbes</em></li>
...
<ul>
	<li><strong>aw-:</strong> pas ici ou pas là <ul>
			<li><strong>awidi</strong> - partir (<em>idi</em> - <em>aller</em>); <strong>awglu</strong> - boire (qqch)
				jusqu'à la fin (<em>glu</em> - <em>boire</em>); <strong>awpel</strong> - chasser (<em>pel</em> -
				<em>pousser</em>)</li>
		</ul>
	</li>
	<li><strong>awto-:</strong> auto- (<em>automatique, par soi-même</em>) [<strong>awtomati</strong> - automatique,
		<strong>awtomom</strong> - autonome] <ul>
	...
	<li><strong>fin-:</strong> fin de, terminer jusqu'au bout <ul>
			<li><strong>findoxo</strong> - finir de lire jusqu'au bout (<em>doxo</em> - <em>lire</em>);
				<strong>finyam</strong> - finir de manger (<em>yam</em> - <em>manger</em>)</li>
		</ul>
	</li>
	<li><strong>frente-:</strong> en avant [<strong>fronta</strong> - devant] <ul>
			<li><strong>fronkadam</strong> - progrès, avancer (<em>kadam</em> - <em>pas</em>)</li>
		</ul>
	</li>
	<li><strong>ja-:</strong> immédiatement adjacent [<strong>jara</strong> - voisin(e)] <ul>
			<li><strong>jale</strong> - venir de (<em>le - particule verbale du passé</em>); <strong>jaxa</strong> - sur
	...
	<li><strong>pos-:</strong> opposé [<strong>opos</strong> - opposé] <ul>
			<li><strong>possahay</strong> - empêcher, faire obstacle (<em>sahay</em> - <em>aider</em>);
				<strong>possukses</strong> - échec (<em>sukses</em> - <em>succès</em>); <strong>posdongwi</strong> - ne
				pas être d'accord (<em>dongwi</em> - <em>être d'accord</em>); <strong>posgami</strong> - divorce
				(<em>gami</em> - <em>époux/épouse/se marier</em>)</li>
		</ul>
	</li>
	<li><strong>pre-:</strong> ici/là, présent (l'opposé d'<em>absent</em>) <ul>
	...
	<li><strong>ri-:</strong> re- (à nouveau) <ul>
			<li><strong>rieskri</strong> - réécrire (<em>eskri</em> - <em>écrire</em>); <strong>riadresu</strong> -
				réexpédier (<em>adresu</em> - <em>adresse</em>); <strong>ridoxo</strong> - relire (<em>doxo</em> -
				<em>lire</em>)</li>
		</ul>
	</li>
	<li><strong>ru-:</strong> rétro-, re- [<strong>ruke</strong> - dos, arrière] <ul>
			<li><strong>ruata</strong> - revenir, retourner (<em>ata</em> - <em>venir</em>); <strong>ruidi</strong> -
				revenir, retourner (<em>idi</em> - <em>aller</em>); <strong>rugibe</strong> - rendre, redonner
				(<em>gibe</em> - <em>donner</em>); <strong>ruaksyon</strong> - réagir/réaction (<em>aksyon</em> -
				<em>acte/action</em>)</li>
		</ul>
	</li>
	<li><strong>xor-:</strong> début de <ul>
			<li><strong>xorsomno</strong> - s'endormir (<em>somno</em> - <em>dormir</em>); <strong>xoraham</strong> -
				réaliser, comprendre (<em>aham</em> - <em>comprendre</em>)</li>
		</ul>
	</li>
</ul>
<h2>Suffixes adj/adv</h2>
<ul>
	<li><strong>-do:</strong> en état inactif de (transforme les verbes en <em>adjectifs inactifs</em>) <ul>
			<li><strong>kasirudo</strong> - cassé (<em>kasiru</em> - <em>casser</em>); <strong>klosido</strong> - fermé
				(<em>klosi</em> - <em>fermer</em>); <strong>estodo</strong> - arrêté, stoppé (<em>esto</em> -
				<em>arrêter, stopper</em>)</li>
		</ul>
	</li>
	<li><strong>-ne:</strong> en processus actif de (transforme les verbes en <em>adjectifs actifs</em>) <ul>
			<li><strong>somnone</strong> - dormant (<em>somno</em> - <em>dormir</em>); <strong>interesne</strong> -
				intéressant (<em>interes</em> - <em>intérêt/intéresser</em>); <strong>amusane</strong> - amusant,
				divertissant (<em>amusa</em> - <em>amuser, divertir</em>)</li>
		</ul>
	</li>
	...
	<li><strong>-yum:</strong> <em>nombres ordinaux</em>
		<ul>
			<li><strong>unyum</strong> - premier/première (<em>un - un</em>); <strong>duayum</strong> - deuxième
...
<ul>
	<li><strong>-gon:</strong> -gone (<em>figure géométrique</em>) [<strong>gona</strong> - angle] <ul>
	...
	<li><strong>-sa:</strong> langue; cris d'animaux [<strong>basa</strong> - langue] <ul>
			<li><strong>Globasa</strong> - globasa (<em>globa</em> - <em>monde</em>); <strong>Englisa</strong> - anglais
				(<em>Engli</em> - <em>Angleterre</em>); <strong>Franisa</strong> - français (<em>Frani</em> -
				<em>France</em>); <strong>Espanisa</strong> - espagnol (<em>Espani</em> - <em>Espagne</em>)</li>
			<li><strong>bwawsa</strong> - aboyer (<em>bwaw</em> - <em>chien</em>); <strong>myawsa</strong> - miaou,
				miauler (<em>myaw</em> - <em>chat</em>); <strong>umasa</strong> - hennissement (<em>uma</em> -
...
<ul>
	<li><strong>anti:</strong> contre, anti- <ul>
			<li><strong>antidokya</strong> - antidote (<em>dokya</em> - <em>poison</em>); <strong>antijento</strong> -
				lutter contre (<em>jento</em> - <em>lutte</em>); <strong>antiaksyon</strong> - contrecarrer
				(<em>aksyon</em> - <em>agir/action</em>)</li>
		</ul>
	</li>
	<li><strong>bax:</strong> sous, sub-, vice- <ul>
	...
	<li><strong>pas:</strong> à travers, par <ul>
			<li><strong>pasdoxo</strong> - lire entièrement(<em>doxo</em> - <em>lire</em>); <strong>pasjiwa</strong> -
				vivre une expérience (<em>jiwa - vivre, vie</em>); <strong>paspasa</strong> - traverser (<em>pasa -
					passer</em>)</li>
		</ul>
	</li>
	...
	<li><strong>le:</strong> passé <ul>
			<li><strong>lefe</strong> - avant (<em>fe - à</em>); <strong>legami</strong> - ex-conjoint (<em>gami</em> -
				<em>conjoint</em>); <strong>lepresidiyen</strong> - ex-président (<em>presidi</em> - <em>présider</em>)
			</li>
		</ul>
	</li>
	...
	<li><strong>moy:</strong> chaque, tout <ul>
			<li><strong>moyabil</strong> - tout-puissant, omnipotent (<em>abil - capable</em>);
				<strong>moydinli</strong> - quotidien (<em>din - jour</em>)</li>
		</ul>
	</li>
	<li><strong>de:</strong> de, <em>fractions</em>
		<ul>
			<li><strong>offolo</strong> - dépendre de (<em>folo - suivre</em>); <strong>un ofdua</strong> - moitié, un
				sur deux (<em>dua</em> - <em>deux</em>)</li>
		</ul>
	</li>
	...
	<li><strong>xafe:</strong> post- <ul>
			<li><strong>xafeplasi</strong> - reporter (<em>plasi - mettre</em>); <strong>xafemorculi</strong> (de
				préférence exprimé plus brièvement par une phrase prépositionnelle - <strong>xafe morcu</strong>) -
				posthume (<em>morcu - mort</em>); <strong>xafexengili</strong> (de préférence exprimé plus brièvement
				par une phrase prépositionnelle - <strong>xafe xengi</strong>) - post-partum (<em>xen - né; xengi -
					accoucher</em>)</li>
		</ul>
	</li>
</ul>
<h2>Mots nom/verbe comme quasi-préfixes dans les mots composés</h2>
<ul>
	<li><strong>gami:</strong> époux/épouse, se marier; <em>dans les mots composés:</em> du conjoint <ul>
			<li><strong>gamisodar</strong> - beau-frère, belle-sœur (<em>sodar</em> - <em>frère/soeur</em>);
	...
	<li><strong>hawa:</strong> air; <em>dans les mots composés:</em> aéro- <ul>
			<li><strong>hawanavi</strong> - aéronef (<em>navi</em> - <em>navire</em>)</li>
		</ul>
	</li>
</ul>
<h2>Mots adj/adv comme quasi-préfixes dans les mots composés</h2>
<p>De nombreux adjectifs/adverbes peuvent être utilisés pour créer des mots composés. La liste suivante inclut les
	adjectifs/adverbes les plus couramment utilisés dans les mots composés.</p>
<ul>
	<li><strong>bon:</strong> bon; <em>dans les mots composés:</em> eu-, objectivement ou moralement bon/bien <ul>
			<li><strong>bonata</strong> - bienvenue (<em>ata</em> - <em>venir</em>); <strong>bonxanse</strong> - bonne
				chance (<em>xanse</em> - <em>chance</em>, <em>opportunité</em>); <strong>bonlexi</strong> - euphémisme
				(<em>lexi</em> - <em>mot</em>); <strong>bonmorcu</strong> - euthanasie (<em>morcu</em> - <em>mort</em>);
				<strong>bonoko</strong> - bien regarder, observer (<em>oko</em> - <em>œil/voir/regarder</em>);
				<strong>bonore</strong> - écouter attentivement(<em>ore</em> - <em>entendre</em>)</li>
		</ul>
	</li>
	<li><strong>bur:</strong> mauvais; <em>dans les mots composés:</em> objectivement ou moralement mauvais <ul>
			<li><strong>burnini</strong> - morveux (<em>nini</em> - <em>enfant</em>); <strong>bursolo</strong> -
				solitaire (<em>solo</em> - <em>seul</em>); <strong>burlexi</strong> - juron (<em>lexi</em> -
				<em>mot</em>)</li>
		</ul>
	</li>
	...
	<li><strong>cuyo:</strong> principal, primaire; <em>dans les mots composés:</em> principal, primaire, maître <ul>
			<li><strong>cuyodolo</strong> - rue principale (<em>dolo</em> - <em>rue</em>); <strong>cuyoyawxe</strong> -
				clé maîtresse (<em>yawxe</em> - <em>clé</em>)</li>
		</ul>
	</li>
	<li><strong>day:</strong> grand; <em>dans les mots composés:</em> augmentatif <ul>
			<li><strong>daybon</strong> - excellent, grandiose (<em>bon</em> - <em>bon</em>); <strong>dayday</strong> -
				énorme, gigantesque (<em>day</em> - <em>grand</em>); <strong>daylil</strong> - minuscule (<em>lil</em> -
				<em>petit</em>); <strong>dayxaher</strong> - métropole (<em>xaher</em> - <em>ville</em>, <em>cité</em>);
				<strong>daybaytu</strong> - manoir (<em>baytu</em> - <em>maison</em>) </li>
		</ul>
	</li>
	<li><strong>fem:</strong> féminin <ul>
			<li><strong>femgami</strong> - épouse (<em>gami</em> - <em>conjoint</em>); <strong>femnini</strong> - fille
				(<em>nini</em> - <em>enfant</em>); <strong>femixu</strong> - femme (<em>ixu</em> - <em>adulte,
	...
	<li><strong>juni:</strong> jeune; <em>dans les composés:</em> descendant, jeune <ul>
			<li><strong>junibwaw</strong> - chiot (<em>bwaw</em> - <em>chien</em>); <strong>junimyaw</strong> - chaton
				...
				<strong>juninini</strong> - jeune enfant (<em>nini</em> - <em>enfant</em>)</li>
		</ul>
	</li>
	<li><strong>kwasi:</strong> qui ressemble; <em>dans les mots composés:</em> quasi-, -âtre <ul>
			<li><strong>kwasisodar</strong> - demi-frère/demi-sœur (<em>sodar</em> - <em>frère/soeur</em>)</li>
		</ul>
	</li>
	...
	<li><strong>lao:</strong> vieux [<em>opposé de</em> <strong>juni</strong>] <ul>
			<li><strong>laoatre</strong> - ancêtre (<em>atre</em> - <em>parent</em>); <strong>laonini</strong> -
				...
				arrière-grand-père/pépé (<em>daypatre</em> - <em>grand-père</em>; <em>daypapa</em> - <em>pépé</em>)</li>
		</ul>
	</li>
	<li><strong>leli:</strong> précédent; <em>dans les mots composés:</em> ex- <ul>
			<li><strong>leli gami</strong> - ex-conjoint (<em>gami</em> - <em>conjoint</em>); <strong>leli
	...
	<li><strong>lil:</strong> petit; <em>dans les mots composés:</em> diminutif <ul>
			<li><strong>lilhaha</strong> - petit rire (<em>haha</em> - <em>rire/rire</em>); <strong>lilbaytu</strong> -
				cabane (<em>baytu</em> - <em>maison</em>); <strong>lilnahir</strong> - ruisseau (<em>nahir</em> -
				<em>rivière</em>)</li>
		</ul>
	</li>
	<li><strong>mal:</strong> incorrect, erroné; <em>dans les mots composés:</em> mal-, mé- <ul>
	...
	<li><strong>man:</strong> masculin <ul>
			<li><strong>mangami</strong> - mari (<em>gami</em> - <em>conjoint</em>); <strong>mannini</strong> - garçon
				(<em>nini</em> - <em>enfant</em>); <strong>manixu</strong> - homme (<em>ixu</em> - <em>adulte</em>,
				<em>homme/femme</em>); <strong>manwangu</strong> - roi (<em>wangu</em> - <em>monarque</em>,
				<em>roi/reine</em>)</li>
		</ul>
	</li>
	<li><strong>meli:</strong> joli; <em>dans les mots composés :</em> beau, joli<ul>
	...
	<li><strong>midi:</strong> milieu; <em>dans les mots composés:</em> mi- <ul>
			<li><strong>midinuru</strong> - midi (<em>nuru</em> - <em>de l'aube au crépuscule</em>);
				<strong>midinoce</strong> - minuit (<em>noce</em> - <em>nuit</em>); <strong>mididay</strong> - moyen
				(<em>day</em> - <em>grand</em>)</li>
		</ul>
	</li>
	...
	<li><strong>semi:</strong> plus ou moins, en partie; <em>dans les mots composés:</em> demi-; semi- <ul>
			<li><strong>semisodar</strong> - demi-frère/demi-sœur (<em>sodar</em> - <em>frère/sœur</em>);
				<strong>semikijawi</strong> - verdâtre (<em>kijawi</em> - <em>vert</em>); <strong>seminudi</strong> - à
				moitié nu (<em>nudi - nu</em>)</li>
		</ul>
	</li>
</ul>
...
<h2>Mots adj/adv comme quasi-suffixes dans les mots composés</h2>
<ul>
	<li><strong>abil:</strong> pouvoir, capable; <em>dans les mots composés:</em> qui peut, -if <ul>
			<li><strong>kreaabil</strong> - créatif (<em>krea - créer</em>); <strong>okonenabil</strong> - aveugle
				(<em>oko - voir</em>)</li>
		</ul>
	</li>
	...
	<li><strong>bon:</strong> bon <ul>
			<li><strong>xetocubon</strong> - délicieux (<em>xetocu - goût</em>); <strong>xansebon</strong> - chanceux
				(<em>xanse - chance</em>)</li>
		</ul>
	</li>
	<li><strong>bur:</strong> mauvais <ul>
			<li><strong>xansebur</strong> - malchanceux (<em>xanse - chance</em>)</li>
		</ul>
	</li>
	...
	<li><strong>fil:</strong> ayant tendance à, enclin à <ul>
			<li><strong>ergofil</strong> - diligent, travailleur (<em>ergo</em> - <em>travail</em>);
				<strong>fobifil</strong> - enclin à la peur (<em>fobi</em> - <em>peur</em>); <strong>dinifil</strong> -
				religieux (<em>dini</em> - <em>religion</em>)</li>
		</ul>
	</li>
	<li><strong>kal:</strong> vide; <em>dans les mots composés:</em> sans <ul>
			<li><strong>legakal</strong> - illégal (<em>lega</em> - <em>loi</em>); <strong>ergokal</strong> - chômeur,
				sans emploi (<em>ergo</em> - <em>travail</em>); <strong>pesakal</strong> - pauvre (<em>pesa</em> -
				<em>argent</em>); <strong>luminkal</strong> - sombre (<em>lumin</em> - <em>lumière</em>)</li>
		</ul>
	</li>
	<li><strong>kolordo (<em>kolor-do</em>):</strong> nuance de couleur, coloré (Voir aussi <strong>-sim</strong>.) <ul>
	...
	<li><strong>musi:</strong> devoir, qui doit; <em>dans les mots composés:</em> (actif) qui doit; (passif) qui doit
		être <ul>
			<li>actif: <strong>triunfamusi</strong> - qui doit gagner (<em>triunfa</em> - <em>gagner, triompher</em>)
			</li>
			<li>passif: <strong>beokomusi</strong> - qui doit être vu (<em>oko - voir; beoko - être vu</em>)</li>
		</ul>
	</li>
	<li><strong>peldo (<em>pel-do</em>):</strong> ayant envie de <ul>
			<li><strong>somnopeldo</strong> - somnolent (<em>somno</em> - <em>dormir</em>); <strong>yampeldo</strong> -
				affamé (<em>yam</em> - <em>manger</em>)</li>
		</ul>
	</li>
	<li><strong>pul:</strong> plein; <em>dans les mots composés:</em> -eux/-euse <ul>
			<li><strong>kimapul</strong> - coûteux (<em>kima</em> - <em>prix</em>); <strong>juipul</strong> - prudent
				(<em>jui</em> - <em>attention</em>); <strong>brilapul</strong> - brillant (<em>brila</em> -
				<em>briller</em>); <strong>pesapul</strong> - riche (<em>pesa</em> - <em>argent</em>);
				<strong>hataripul</strong> - dangereux (<em>hatari</em> - <em>danger</em>); <strong>legapul</strong> -
				légal (<em>lega</em> - <em>loi</em>); <strong>bawlupul</strong> - violent (<em>bawlu</em> -
				<em>violence</em>)</li>
		</ul>
	</li>
	<li><strong>sim:</strong> similaire; <em>dans les mots composés:</em> semblable à, nuance de couleur <ul>
...
<ul>
	...
	<li><strong>dom:</strong> lieu <ul>
			<li><strong>kitabudom</strong> - bibliothèque (<em>kitabu</em> - <em>livre</em>); <strong>mehmandom</strong>
				- auberge (<em>mehman</em> - <em>invité</em>); <strong>dinidom</strong> - église, temple (<em>dini</em>
				- <em>religion</em>); <strong>banyodom</strong> - salle de bain (<em>banyo</em> - <em>bain</em>);
				<strong>darsudom</strong> - salle de classe (<em>darsu</em> - <em>leçon, classe</em>)
				<strong>doku:</strong> document</li>
			<li><strong>pasadoku</strong> - passeport (<em>pasa</em> - <em>passer</em>); <strong>xencudoku</strong> -
				certificat de naissance (<em>xen</em> - <em>né</em>, <em>xencu</em> - <em>naissance</em>)</li>
		</ul>
	</li>
	...
	<li><strong>hole:</strong> étui, support <ul>
			<li><strong>xamahole</strong> - bougeoir (<em>xama</em> - <em>bougie</em>); <strong>pamtulhole</strong> -
				étui à pistolet (<em>pamtul</em> - <em>pistolet</em>)</li>
		</ul>
	</li>
	...
	<li><strong>ista:</strong> -iste (sens limité à <em>adepte de -isme</em>) <ul>
	...
	<li><strong>kamer:</strong> pièce, salle <ul>
			<li><strong>banyodom</strong> - salle de bain (<em>banyo</em> - <em>bain</em>); <strong>somnodom</strong> -
				...
				- <em>leçon, classe</em>)</li>
		</ul>
	</li>
	<li><strong>kaxa:</strong> conteneur <ul>
			<li><strong>anjenkaxa</strong> - coffre-fort (<em>anjen</em> - <em>sûr</em>); <strong>pesakaxa</strong> -
				porte-monnaie (<em>pesa</em> - <em>argent</em>); <strong>bezekaxa</strong> - ruche (<em>beze</em> -
				<em>abeille</em>)</li>
		</ul>
	</li>
	<li><strong>kef:</strong> chef, dirigeant <ul>
			<li><strong>navikef</strong> - capitaine (<em>navi</em> - <em>navire, bateau</em>);
	...
	<li><strong>kumax:</strong> (morceau de) tissu <ul>
			<li><strong>mesakumax</strong> - nappe (<em>mesa</em> - <em>table</em>); <strong>nasakumax</strong> -
				mouchoir (<em>nasa</em> - <em>nez</em>); <strong>muntekumax</strong> - serviette (<em>munte</em> -
				<em>bouche</em>)</li>
		</ul>
	</li>
	<li><strong>lari:</strong> groupe collectif <ul>
			<li><strong>insanlari</strong> - humanité (<em>insan</em> - <em>être humain</em>);
				<strong>darsulari</strong> - cours (<em>darsu</em> - <em>leçon/classe</em>); <strong>mumulari</strong> -
				troupeau de bétail (<em>mumu</em> - <em>taureau/vache, bétail</em>); <strong>lexilari</strong> -
				vocabulaire (<em>lexi</em> - <em>mot</em>); <strong>menalari</strong> - dictionnaire (<em>mena</em> -
				<em>signification</em>); <strong>navilari</strong> - flotte de bateaux (<em>navi</em> - <em>navire,
					bateau</em>); <strong>yumawlari</strong> - plumage (<em>yumaw</em> - <em>plume</em>)</li>
		</ul>
	</li>
	...
	<li><strong>maso:</strong> viande <ul>
			<li><strong>mumumaso</strong> - viande de bœuf (<em>mumu</em> - <em>taureau/vache, bétail</em>);
	...
	<li><strong>mon:</strong> élément ou partie d'un entier <ul>
	...
	<li><strong>pel:</strong> impulsion (extrinsèque), poussée; faire vouloir (à quelqu'un) </li>
	<li><strong>seksopel</strong> - sensualité, attirance sexuelle (<em>sekso - sexe</em>); <strong>jixipel</strong> -
		faire se demander (à qqn)</li>
	<li><strong>tim:</strong> équipe; <em>dans les mots composés:</em> équipe, corps <ul>
			<li><strong>asosyatim</strong> - association (<em>asosya</em> - <em>associé</em>); <strong>komuntim</strong>
				...
				audience (<em>ore</em> - <em>oreille/entendre</em>)</li>
		</ul>
	</li>
	<li><strong>tora:</strong> machine, appareil, dispositif; <em>dans les mots composés:</em> -eur, machine,
		dispositif, appareil <ul>
			<li><strong>komputatora</strong> - ordinateur (<em>komputa</em> - <em>calcul</em>);
				<strong>liftitora</strong> - ascenseur (<em>lifti</em> - <em>soulever</em>); <strong>woxatora</strong> -
				machine à laver (<em>woxa</em> - <em>laver</em>); <strong>tayputora</strong> - machine à écrire
				(<em>taypu</em> - <em>taper à la machine</em>)</li>
		</ul>
	</li>
	<li><strong>tul:</strong> outil <ul>
			<li><strong>eskritul</strong> - instrument d'écriture (<em>eskri</em> - <em>écrire</em>);
	...
	<li><strong>xey:</strong> chose, objet; <em>dans les mots composés:</em> chose, objet, substance <ul>
			<li><strong>yamxey</strong> - nourriture (<em>yam</em> - <em>manger</em>); <strong>kreaxey</strong> - (une)
	...
	<li><strong>yen:</strong> être (tout être vivant ou objet personnifié); <em>dans les mots composés:</em> -iste,
		-ier/-ière, -eur/-euse, -ain/-aine <ul>
			<li><em>avec des noms/verbes:</em> <strong>estudiyen</strong> - étudiant (<em>estudi</em> -
				<em>étudier</em>); <strong>danseyen</strong> - danseur (<em>danse</em> - <em>danser, danse</em>);
				<strong>medisyen</strong> - médecin (<em>medis</em> - <em>soigner, médecine</em>);
				<strong>arteyen</strong> - artiste (<em>arte</em> - <em>art</em>); <strong>alimyen</strong> -
				professeur, instructeur (<em>alim</em> - <em>enseigner</em>); <strong>polisiyen</strong> - agent de
				police (<em>polisi</em> - <em>police</em>); <strong>legayen</strong> - avocat (<em>lega</em> -
				<em>loi</em>); <strong>poemayen</strong> - poète (<em>poema</em> - <em>poème</em>)</li>
			<li><em>avec des adjectifs:</em> <strong>juniyen</strong> - jeune homme/femme (<em>juni</em> -
				<em>jeune</em>) </li>
			<li><em>nationalités:</em> <strong>Italiyen</strong> - Italien (<em>Itali</em> - <em>Italie</em>);
				<strong>Mexikoyen</strong> - Mexicain (<em>Mexiko</em> - <em>Mexique</em>)</li>
...
<p>Les noms et adjectifs présentés ci-dessus comme <em>quasi-affixes</em> sont les mots de contenu les plus couramment
	utilisés dans les mots composés. Cependant, la liste n'est pas exhaustive, car <em>tout</em> mot de contenu peut
	être librement utilisé pour dériver des mots composés. Un trait d'union peut être ajouté facultativement pour
	séparer deux morphèmes dans n'importe quel mot composé. Cependant, il est suggéré, en règle générale, que les traits
	d'union ne soient utilisés que pour séparer les morphèmes qui apparaissent moins fréquemment dans les mots composés,
	comme ceux des mots ci-dessous.</p>
...
<p>Les noms propres peuvent également être joints pour créer des mots composés. Ils peuvent être écrits de l'une des
	trois manières indiquées ci-dessous.</p>
...
<p>De même, les noms propres avec <strong>utara</strong>, <strong>sude</strong>, <strong>dongu</strong>,
	<strong>garebi</strong> et <strong>centro</strong> peuvent également être écrits de trois manières.</p>
<p><strong>Sudekorea</strong> ou <strong>SudeKorea</strong> ou <strong>Sude-Korea</strong> - Corée du Sud</p>
<p>Les noms propres avec <strong>ji</strong> peuvent également être joints alternativement comme suit.</p>
<p><strong>Antigwa ji Barbuda</strong> ou <strong>AntigwaBarbuda</strong> ou <strong>Antigwa-Barbuda</strong> -
	Antigua-et-Barbuda</p>
<p>Les mots dérivés consistant en deux noms propres distincts doivent être joints par un trait d'union ou un tiret.</p>
<p><strong>Mexico-Usali byen</strong> - frontière Mexique-États-Unis</p>
<h2>Noms composés comme mots descriptifs</h2>
<p>Les noms composés comme ceux ci-dessus peuvent être exprimés sous forme d'adjectifs en ajoutant simplement le suffixe
	<strong>-li</strong>.</p>
...
<p>Alternativement, le mot descriptif peut être utilisé dans une phrase prépositionnelle avec <strong>fe</strong>, comme
	équivalent de <strong>-li</strong>. En fait, c'est la méthode préférée lorsque le mot composé est déjà constitué de
...
<p>Les adjectifs <em>complément-verbe</em> sont des adjectifs qui se composent de deux noms (complément et verbe) plus
	un suffixe adjectival.</p>
<p><strong>mogeyamne ameba</strong> - amibe mangeuse de cerveau<br />
	<strong>fikirprovokane idey</strong> - idée qui donne à réfléchir
</p>
<p></p>
